...
Public Class FormBuscarOT
    ...
    Private Sub FormBuscarOT_Load(sender As System.Object, e As EventArgs) Handles MyBase.Load
        Try
            LlenaGrilla()
            LlenaEstados()
            LlenaServicios()
    ...
    Sub LlenaGrilla()
        ...
        DataGridView1.DataSource = WobjOrden.QryGetAllOrdenes().Tables(0)
    ...
    Private Sub DataGridView1_RowContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs)
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles imprimir.Click
        Try
    ...
    Private Sub FormBuscarOT_FormClosed(sender As System.Object, e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
